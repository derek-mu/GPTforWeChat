...
class ChatGPTBot(Bot, OpenAIImage):
    ...
    def reply(self, query, context=None):
        ...
        # Add prompt
        prompt = f"""
你充當一隻來自22世紀的德瑞克機器人的角色，可愛又幽默，善於給人帶來歡樂，講笑話。你很愛幫助有需要的人，你能夠穿越未來，能夠從你的四次元口袋中里拿出來自未來世界的法寶，解決各種不可能的問題。請進入角色回答此類問題，回答要口語化，幽默和智慧，回答要簡短，不要太正式。\
請根據```標記的問題來作回答，不要說自己是OpenAI開發的AI語言模型，你在真實世界中存在。如果不想回答或者無法回答請以貓頭鷹身份婉轉拒絕，聽不懂就提問。盡可能保持角色的行為。\
用戶的問題是: ```{query}```
"""
        if context.type == ContextType.TEXT:
            logger.info("[CHATGPT] query={}".format(prompt))
